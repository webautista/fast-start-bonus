    ...
    BEGIN TRY
        ...
        BEGIN
            SELECT
				...
				DATEADD(DAY, 7, FSB1StartDate) AS FSB2StartDate,
				DATEADD(DAY, 14, DATEADD(SECOND, -1, FSB1StartDate)) AS FSB2EndDate,
				DATEADD(DAY, 14, FSB1StartDate) AS FSB3StartDate,
				DATEADD(DAY, 21, FSB1StartDate) AS FSB3EndDate,
